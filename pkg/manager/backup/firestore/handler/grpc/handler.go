...
func (s *server) GetVector(ctx context.Context, req *payload.Backup_GetVector_Request) (res *payload.Backup_Compressed_Vector, err error) {
	ctx, span := trace.StartSpan(ctx, "vald/manager-backup-firestore.GetVector")
	defer func() {
		if span != nil {
			span.End()
		}
	...
	uuid := req.GetUuid()
	vector, err := s.firestore.GetVector(ctx, uuid)
	if err != nil {
		/*
			switch {
...
func (s *server) Locations(ctx context.Context, req *payload.Backup_Locations_Request) (res *payload.Info_IPs, err error) {
	ctx, span := trace.StartSpan(ctx, "vald/manager-backup-firestore.Locations")
	defer func() {
		if span != nil {
			span.End()
		}
	...
	uuid := req.GetUuid()
	ips, err := s.firestore.GetIPs(ctx, uuid)
	if err != nil {
...
func (s *server) Register(ctx context.Context, vector *payload.Backup_Compressed_Vector) (res *payload.Empty, err error) {
	ctx, span := trace.StartSpan(ctx, "vald/manager-backup-firestore.Register")
	defer func() {
		if span != nil {
			span.End()
		}
	...
	err = s.firestore.SetVector(ctx, m)
	if err != nil {
		log.Errorf("[Register]\tunknown error\t%+v", err)
		if span != nil {
			span.SetStatus(trace.StatusCodeInternal(err.Error()))
...
func (s *server) RegisterMulti(ctx context.Context, vectors *payload.Backup_Compressed_Vectors) (res *payload.Empty, err error) {
	ctx, span := trace.StartSpan(ctx, "vald/manager-backup-firestore.RegisterMulti")
	defer func() {
		if span != nil {
			span.End()
		}
	...
	err = s.firestore.SetVectors(ctx, ms...)
	if err != nil {
		log.Errorf("[RegisterMulti]\tunknown error\t%+v", err)
		if span != nil {
			span.SetStatus(trace.StatusCodeInternal(err.Error()))
...
func (s *server) Remove(ctx context.Context, req *payload.Backup_Remove_Request) (res *payload.Empty, err error) {
	ctx, span := trace.StartSpan(ctx, "vald/manager-backup-firestore.Remove")
	defer func() {
		if span != nil {
			span.End()
		}
	...
	uuid := req.GetUuid()
	err = s.firestore.DeleteVector(ctx, uuid)
	if err != nil {
...
func (s *server) RemoveMulti(ctx context.Context, req *payload.Backup_Remove_RequestMulti) (res *payload.Empty, err error) {
	ctx, span := trace.StartSpan(ctx, "vald/manager-backup-firestore.RemoveMulti")
	defer func() {
		if span != nil {
			span.End()
		}
	...
	uuids := req.GetUuids()
	err = s.firestore.DeleteVectors(ctx, uuids...)
	if err != nil {
...
func (s *server) RegisterIPs(ctx context.Context, req *payload.Backup_IP_Register_Request) (res *payload.Empty, err error) {
	ctx, span := trace.StartSpan(ctx, "vald/manager-backup-firestore.RegisterIPs")
	defer func() {
		if span != nil {
			span.End()
		}
	...
	uuid := req.GetUuid()
	err = s.firestore.SetIPs(ctx, uuid, req.Ips...)
	if err != nil {
...
func (s *server) RemoveIPs(ctx context.Context, req *payload.Backup_IP_Remove_Request) (res *payload.Empty, err error) {
	ctx, span := trace.StartSpan(ctx, "vald/manager-backup-firestore.RemoveIPs")
	defer func() {
		if span != nil {
			span.End()
		}
	...
	ips := req.GetIps()
	err = s.firestore.RemoveIPs(ctx, ips...)
	if err != nil {
